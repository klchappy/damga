    ...
    <div className="fixed inset-0 bg-black text-white overflow-hidden">
      ...
      {cameraError && (
        <div className="absolute inset-0 flex items-center justify-center z-10 p-8">
          <div className="bg-red-950/90 border border-red-500/50 rounded-2xl p-6 max-w-md text-center">
            <XCircle className="size-12 mx-auto mb-3 text-red-400" />
            <h2 className="text-xl font-bold">Kamera açılamadı</h2>
            <p className="mt-2 text-sm text-red-200">{cameraError}</p>
            <p className="mt-3 text-xs text-red-300">
              Tarayıcı izinlerini kontrol et veya cihazı yeniden başlat.
            </p>
          </div>
        </div>
      )}
