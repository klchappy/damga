  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <nav className="border-b border-zinc-100 bg-white/80 backdrop-blur sticky top-0 z-30">
        <div className="mx-auto max-w-6xl px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <Link
              to="/auth/sign-up-org"
              className="rounded-lg bg-orange-500 hover:bg-orange-600 text-white px-4 py-1.5 font-medium"
            >
              Ücretsiz başla
            </Link>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 md:py-24 text-center">
        <div className="inline-flex items-center gap-2 rounded-full bg-orange-50 text-orange-600 px-3 py-1 text-xs font-medium mb-6">
        ...
        <h1 className="text-4xl md:text-6xl font-bold tracking-tight max-w-3xl mx-auto leading-tight">
          Çalışanların geliş-gidişi <span className="text-orange-500">kanıtlı</span> ve şeffaf
        </h1>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <Link
            to="/auth/sign-up-org"
            className="inline-flex items-center gap-2 rounded-xl bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 font-semibold shadow-sm hover:shadow-md transition"
          >
            Ücretsiz başla
      ...
      <section id="nasil-calisir" className="mx-auto max-w-6xl px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {FEATURES.map((f) => (
            <div key={f.title} className="p-6 rounded-2xl border border-zinc-100 hover:border-orange-200 hover:shadow-sm transition">
      ...
      <section id="fiyatlar" className="mx-auto max-w-6xl px-4 py-16">
          ...
          {PLANS.map((p) => (
            <div
              ...
              className={`rounded-2xl p-6 border-2 ${
                p.highlighted
                  ? 'border-orange-500 bg-orange-50/50 shadow-lg relative'
                  : 'border-zinc-100'
              }`}
            >
              {p.highlighted && (
        ...
        <p className="text-center text-xs text-zinc-500 mt-8">
          ...
          <a href="mailto:satis@deploi.net" className="text-orange-500 hover:underline">
            satis@deploi.net
          </a>
        </p>
      </section>
      ...
      <section className="bg-zinc-50 border-y border-zinc-100">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-4 text-sm">
            <Link to="/legal/kvkk" className="text-orange-500 hover:underline">
              KVKK Aydınlatma Metni
            </Link>
            <span className="text-zinc-300">·</span>
            <Link to="/legal/privacy" className="text-orange-500 hover:underline">
              Gizlilik Politikası
            </Link>
            <span className="text-zinc-300">·</span>
            ...
            <span className="text-zinc-300">·</span>
            <Link to="/status" className="text-orange-500 hover:underline">
              Sistem Durumu
            </Link>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-3xl px-4 py-20 text-center">
        ...
        <Link
          to="/auth/sign-up-org"
          className="mt-8 inline-flex items-center gap-2 rounded-xl bg-orange-500 hover:bg-orange-600 text-white px-8 py-3.5 font-semibold shadow-md hover:shadow-lg transition"
        >
          Ücretsiz hesap aç
          <ArrowRight className="w-4 h-4" />
        </Link>
      ...
      <footer className="border-t border-zinc-100">
        <div className="mx-auto max-w-6xl px-4 py-10 text-sm text-zinc-500 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex items-center gap-2">
            <span className="w-6 h-6 rounded-md bg-orange-500 text-white flex items-center justify-center">
